...
namespace MyNatsClient
{
    public interface INatsConsumer
    {
        ...
        /// <returns></returns>
        IConsumerSubscription Subscribe(string subject, IObserver<MsgOp> observer, int? unsubAfterNMessages = null);
        ...
        /// <param name="unsubAfterNMessages">Pass a value to automatically unsubscribe after N messages.</param>
        /// <returns></returns>
        IConsumerSubscription Subscribe(SubscriptionInfo subscriptionInfo, IObserver<MsgOp> observer, int? unsubAfterNMessages = null);
        ...
        /// <param name="unsubAfterNMessages">Pass a value to automatically unsubscribe after N messages.</param>
        /// <returns></returns>
        Task<IConsumerSubscription> SubscribeAsync(string subject, IObserver<MsgOp> observer, int? unsubAfterNMessages = null);
